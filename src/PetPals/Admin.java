...
public class Admin extends javax.swing.JFrame {
    ...
    void addPet() {
        String pname = petNameTF.getText();
        String psex = (String) petSexCB.getSelectedItem();
        String ptype = petTypeTF.getText();
        String pbreed = petBreedTF.getText();
        String pweight = petWeightTF.getText();
        String pcolor = petColorTF.getText();
        
        if(pname.equals("") || pname.equals("Enter Pet Name")){
            JOptionPane.showMessageDialog(null, "Enter Pet Name.");
        }
        else if(psex == null){
            JOptionPane.showMessageDialog(null, "Enter Pet Sex.");
        }
        else if(ptype.equals("") || ptype.equals("Enter Type of Pet")){
            JOptionPane.showMessageDialog(null, "Enter Type of Pet.");
        }
        else if(pbreed.equals("") || pbreed.equals("Enter Breed")){
            JOptionPane.showMessageDialog(null, "Enter Breed.");
        }  
        else if(pweight.equals("") || pweight.equals("Enter Weight")){
            JOptionPane.showMessageDialog(null, "Enter Weight.");
        }
        else if(pcolor.equals("") || pcolor.equals("Enter Color")){
             JOptionPane.showMessageDialog(null, "Enter Color.");
        }
        else {
        try {
            PreparedStatement ps = Database.connect().prepareStatement("INSERT INTO `pets_table`(`PetName`, `PetSex`, `Species`, `Breed`, `Weight`, `Color`,`Available`) VALUES (?,?,?,?,?,?,?)");
            ps.setString(1, pname);
            ps.setString(2, psex);
            ps.setString(3, ptype);
            ps.setString(4, pbreed);
            ps.setString(5, pweight);
            ps.setString(6, pcolor);
    ...
    void editPet() {
        String npname = petNameTF.getText();
        String npsex = (String) petSexCB.getSelectedItem();
        String nptype = petTypeTF.getText();
        String npbreed = petBreedTF.getText();
        String npweight = petWeightTF.getText();
        String npcolor = petColorTF.getText();
        
        if(npname.equals("") || npname.equals("Enter Pet Name")){
            JOptionPane.showMessageDialog(null, "Enter Pet Name.");
        }
        else if(npsex == null){
            JOptionPane.showMessageDialog(null, "Enter Pet Sex.");
        }
        else if(nptype.equals("") || nptype.equals("Enter Type of Pet")){
            JOptionPane.showMessageDialog(null, "Enter Type of Pet.");
        }
        else if(npbreed.equals("") || npbreed.equals("Enter Breed")){
            JOptionPane.showMessageDialog(null, "Enter Breed.");
        }  
        else if(npweight.equals("") || npweight.equals("Enter Weight")){
            JOptionPane.showMessageDialog(null, "Enter Weight.");
        }
        else if(npcolor.equals("") || npcolor.equals("Enter Color")){
             JOptionPane.showMessageDialog(null, "Enter Color.");
        }
        else {
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            PreparedStatement ps = Database.connect().prepareStatement("UPDATE `pets_table` SET"
                + "`PetSex`='" + npsex + 
                "',`Species`='" + nptype +
                "', `Breed`='" + npbreed +
                "',`Weight`='" + npweight +
                "',`Color`='" + npcolor +
                "' WHERE pets_table.PetName = '" + npname + "'");
            ps.executeUpdate();
    ...
    void deletePet() {
        ...
        int selectedIndex = petsTable.getSelectedRow();
        try {
            String rn = model.getValueAt(selectedIndex, 1).toString();
            int dialogResult = JOptionPane.showConfirmDialog(null, "Do you want to delete this pet?", "Warning", JOptionPane.YES_NO_OPTION);
            if (dialogResult == JOptionPane.YES_OPTION) {
                PreparedStatement ps = Database.connect().prepareStatement("DELETE FROM pets_table WHERE PetName = ?");
                ps.setString(1, rn);
                ps.executeUpdate();
    ...
    void fillFromPetsTable() {
        try {
            PreparedStatement ps = Database.connect().prepareStatement("SELECT * FROM `pets_table`");
            DefaultTableModel tm = (DefaultTableModel) petsTable.getModel();
            int si = petsTable.getSelectedRow();
            petNameTF.setText((String) tm.getValueAt(si, 1));
            petSexCB.setSelectedItem(tm.getValueAt(si, 2));
            petTypeTF.setText((String) tm.getValueAt(si, 3));
            petBreedTF.setText((String) tm.getValueAt(si, 4));
            petWeightTF.setText((String) tm.getValueAt(si, 5));
            petColorTF.setText((String) tm.getValueAt(si, 6));
            
            petNameTF.setForeground(new Color(238,134,175));
            petSexCB.setForeground(new Color(238,134,175));
            petTypeTF.setForeground(new Color(238,134,175));
            petBreedTF.setForeground(new Color(238,134,175));
            petWeightTF.setForeground(new Color(238,134,175));
            petColorTF.setForeground(new Color(238,134,175));
...
public boolean checkUsername(String username) {
    ...
    private void initComponents() {
        ...
        petTypeTF = new javax.swing.JTextField();
        jLabel10 = new javax.swing.JLabel();
        petSexCB = new javax.swing.JComboBox<>();
        jLabel11 = new javax.swing.JLabel();
        petBreedTF = new javax.swing.JTextField();
        jLabel27 = new javax.swing.JLabel();
        petWeightTF = new javax.swing.JTextField();
        jLabel28 = new javax.swing.JLabel();
        petColorTF = new javax.swing.JTextField();
        mpDelete = new javax.swing.JPanel();
        jLabel34 = new javax.swing.JLabel();
        mpEdit = new javax.swing.JPanel();
        jLabel40 = new javax.swing.JLabel();
        mpAdd = new javax.swing.JPanel();
        jLabel41 = new javax.swing.JLabel();
        mpClear = new javax.swing.JPanel();
        ...
        jLabel8.setForeground(new java.awt.Color(238, 134, 175));
        jLabel8.setText("Pet Name");

        petNameTF.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        petNameTF.setForeground(new java.awt.Color(153, 153, 153));
        petNameTF.setText("Enter Pet Name");
        petNameTF.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(120, 184, 198), 2, true));
        petNameTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                petNameTFFocusGained(evt);
            }
        });
        ...
        petTypeTF.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        petTypeTF.setForeground(new java.awt.Color(153, 153, 153));
        petTypeTF.setText("Enter Type of Pet");
        petTypeTF.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(120, 184, 198), 2, true));
        petTypeTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                petTypeTFFocusGained(evt);
            }
        });

        jLabel10.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(238, 134, 175));
        jLabel10.setText("Type");

        petSexCB.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        petSexCB.setForeground(new java.awt.Color(153, 153, 153));
        petSexCB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female" }));
        petSexCB.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(120, 184, 198), 2, true));
        petSexCB.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                petSexCBFocusGained(evt);
            }
        });

        jLabel11.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(238, 134, 175));
        jLabel11.setText("Breed");

        petBreedTF.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        petBreedTF.setForeground(new java.awt.Color(153, 153, 153));
        petBreedTF.setText("Enter Breed");
        petBreedTF.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(120, 184, 198), 2, true));
        petBreedTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                petBreedTFFocusGained(evt);
            }
        });

        jLabel27.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel27.setForeground(new java.awt.Color(238, 134, 175));
        jLabel27.setText("Weight");

        petWeightTF.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        petWeightTF.setForeground(new java.awt.Color(153, 153, 153));
        petWeightTF.setText("Enter Weight");
        petWeightTF.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(120, 184, 198), 2, true));
        petWeightTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                petWeightTFFocusGained(evt);
            }
        });

        jLabel28.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        jLabel28.setForeground(new java.awt.Color(238, 134, 175));
        jLabel28.setText("Color");

        petColorTF.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N
        petColorTF.setForeground(new java.awt.Color(153, 153, 153));
        petColorTF.setText("Enter Color");
        petColorTF.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(120, 184, 198), 2, true));
        petColorTF.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                petColorTFFocusGained(evt);
            }
        });

        mpDelete.setBackground(new java.awt.Color(238, 134, 175));
        mpDelete.setPreferredSize(new java.awt.Dimension(150, 35));
        mpDelete.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                mpDeleteMouseClicked(evt);
            }
        });
        ...
        javax.swing.GroupLayout mpDeleteLayout = new javax.swing.GroupLayout(mpDelete);
        mpDelete.setLayout(mpDeleteLayout);
        mpDeleteLayout.setHorizontalGroup(
            mpDeleteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mpDeleteLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel34, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                .addContainerGap())
        );
        mpDeleteLayout.setVerticalGroup(
            mpDeleteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mpDeleteLayout.createSequentialGroup()
                .addContainerGap()
        ...
        mpEdit.setBackground(new java.awt.Color(238, 134, 175));
        mpEdit.setPreferredSize(new java.awt.Dimension(150, 35));
        mpEdit.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                mpEditMouseClicked(evt);
            }
        });
        ...
        javax.swing.GroupLayout mpEditLayout = new javax.swing.GroupLayout(mpEdit);
        mpEdit.setLayout(mpEditLayout);
        mpEditLayout.setHorizontalGroup(
            mpEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mpEditLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel40, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                .addContainerGap())
        );
        mpEditLayout.setVerticalGroup(
            mpEditLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mpEditLayout.createSequentialGroup()
                .addContainerGap()
        ...
        mpAdd.setBackground(new java.awt.Color(238, 134, 175));
        mpAdd.setPreferredSize(new java.awt.Dimension(150, 35));
        ...
        javax.swing.GroupLayout mpAddLayout = new javax.swing.GroupLayout(mpAdd);
        mpAdd.setLayout(mpAddLayout);
        mpAddLayout.setHorizontalGroup(
            mpAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mpAddLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel41, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                .addContainerGap())
        );
        mpAddLayout.setVerticalGroup(
            mpAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mpAddLayout.createSequentialGroup()
                .addContainerGap()
        ...
        mpClear.setBackground(new java.awt.Color(238, 134, 175));
        mpClear.setPreferredSize(new java.awt.Dimension(150, 35));
        mpClear.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                mpClearMouseClicked(evt);
            }
        });
        ...
        javax.swing.GroupLayout mpClearLayout = new javax.swing.GroupLayout(mpClear);
        mpClear.setLayout(mpClearLayout);
        mpClearLayout.setHorizontalGroup(
            mpClearLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mpClearLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel33, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                .addContainerGap())
        );
        mpClearLayout.setVerticalGroup(
            mpClearLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(mpClearLayout.createSequentialGroup()
                .addContainerGap()
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(mpClear, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(mpAdd, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(mpEdit, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(mpDelete, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(64, 64, 64))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel28)
                    .addComponent(petWeightTF)
                    .addComponent(jLabel27)
                    .addComponent(jLabel11)
                    .addComponent(petSexCB, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jLabel10)
                    .addComponent(petTypeTF)
                    .addComponent(jLabel9)
                    .addComponent(jLabel8)
                    .addComponent(petBreedTF)
                    .addComponent(petColorTF)
                    .addComponent(petNameTF, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel8)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(petNameTF, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel9)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(petSexCB, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel10)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(petTypeTF, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel11)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(petBreedTF, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel27)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(petWeightTF, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel28)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(petColorTF, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(mpAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(mpClear, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(7, 7, 7)
                .addComponent(mpEdit, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(mpDelete, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(11, 11, 11))
        );
    ...
    private void petNameTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_petNameTFFocusGained
        // TODO add your handling code here:
        if (petNameTF.getText().equals("Enter Pet Name")){
            petNameTF.setText("");
            petNameTF.setForeground(new Color(238,134,175));
        }
    }//GEN-LAST:event_petNameTFFocusGained

    private void petTypeTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_petTypeTFFocusGained
        // TODO add your handling code here:
        if (petTypeTF.getText().equals("Enter Type of Pet")){
            petTypeTF.setText("");
            petTypeTF.setForeground(new Color(238,134,175));
        }
    }//GEN-LAST:event_petTypeTFFocusGained

    private void petSexCBFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_petSexCBFocusGained
        // TODO add your handling code here:
        petSexCB.setForeground(new Color(238,134,175));
    }//GEN-LAST:event_petSexCBFocusGained

    private void petBreedTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_petBreedTFFocusGained
        // TODO add your handling code here:
        if (petBreedTF.getText().equals("Enter Breed")){
            petBreedTF.setText("");
            petBreedTF.setForeground(new Color(238,134,175));
        }
    }//GEN-LAST:event_petBreedTFFocusGained

    private void petWeightTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_petWeightTFFocusGained
        // TODO add your handling code here:
        if (petWeightTF.getText().equals("Enter Weight")){
            petWeightTF.setText("");
            petWeightTF.setForeground(new Color(238,134,175));
        }
    }//GEN-LAST:event_petWeightTFFocusGained

    private void petColorTFFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_petColorTFFocusGained
        // TODO add your handling code here:
        if (petColorTF.getText().equals("Enter Color")){
            petColorTF.setText("");
            petColorTF.setForeground(new Color(238,134,175));
        }
    }//GEN-LAST:event_petColorTFFocusGained

    private void mpDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mpDeleteMouseClicked
        // TODO add your handling code here:
        deletePet();
    }//GEN-LAST:event_mpDeleteMouseClicked

    private void mpEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mpEditMouseClicked
        // TODO add your handling code here:
        editPet();
    }//GEN-LAST:event_mpEditMouseClicked
    ...
    private void mpClearMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mpClearMouseClicked
        // TODO add your handling code here:
        petNameTF.setText("");
        petSexCB.setSelectedItem(null);
        petTypeTF.setText("");
        ...
        petWeightTF.setText("");
        petColorTF.setText("");
    }//GEN-LAST:event_mpClearMouseClicked
    ...
    private javax.swing.JPanel mpAdd;
    private javax.swing.JPanel mpClear;
    private javax.swing.JPanel mpDelete;
    private javax.swing.JPanel mpEdit;
    private javax.swing.JTextField mpSearchTF;
    private javax.swing.JTextField petBreedTF;
    private javax.swing.JTextField petColorTF;
    ...
    private javax.swing.JComboBox<String> petSexCB;
    private javax.swing.JTextField petTypeTF;
    private javax.swing.JTextField petWeightTF;
